...
Status: Approved scope check for Phase 4 implementation on 2026-08-25, mapped to the official rubric on 2026-08-26

This is the Phase 4 scope test. It is not the final polished pitch.

The official rubric awards 10 points each for Functionality & Execution, Innovation, Problem & Impact, UX & Usability, and Technical Merit. The 90-second version also fits the submission form's optional 1 to 2 minute video range.
...
Criteria: Problem & Impact, Innovation, and UX & Usability.
...
Criteria: Functionality & Execution, UX & Usability, and Technical Merit.
...
Criteria: Functionality & Execution, Innovation, and Technical Merit.
...
Criteria: UX & Usability, Problem & Impact, and Technical Merit.
...
Criteria: Functionality & Execution and Technical Merit.
...
Criteria: all five. The working release proves execution, the separate Witness proves differentiated multi-agent design, the public evidence resolves the trust problem, the proof is understandable, and the reverse chain path demonstrates technical merit.
...
| Criterion | What the judge sees in 90 seconds |
| --- | --- |
| Functionality & Execution | Bad input is blocked, deterministic checks pass, the approved release reaches a real contract, and the independent proof resolves |
| Innovation | Five agents have different authority and cannot collapse into one self-approving AI |
| Problem & Impact | A developer can prove which requested, tested, and approved artifact became the deployed contract |
| UX & Usability | Plain language, one fixed relay, a readable approval, recoverable failure, and a public result |
| Technical Merit | Rust Stylus, fixed tests, canonical evidence, wallet approval, HERŌ roots, Arbitrum deployment, and an independent Witness |
